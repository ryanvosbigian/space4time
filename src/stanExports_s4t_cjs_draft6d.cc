...
#include "stanExports_s4t_cjs_draft6d.h"

RCPP_MODULE(stan_fit4s4t_cjs_draft6d_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_s4t_cjs_draft6d")
