...
#include "stanExports_s4t_cjs_fixedage_draft7.h"

RCPP_MODULE(stan_fit4s4t_cjs_fixedage_draft7_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_s4t_cjs_fixedage_draft7")
