...
```{r}
linear_s4t_config(site_names = c("A","B","C"),
                  holdover_sites = "A",
                  min_a = c("A" = 0,"B" = 1,"C" = 1),
                  max_a = c("A" = 3,"B" = 4,"C" = 4))
```
...
```{r}
linear_s4t_config(site_names = c("A","B","C","D"),
                  holdover_sites = "A",
...
```{r}
simplebranch_s4t_config(site_names = c("A","B","C","D"),
                        branch_sites = c("A","B"),
...
```{r}
simplebranch_s4t_config(site_names = c("A","B","C","D","E"),
                        branch_sites = c("A","B"),
                        holdover_sites = c("A","B"),
